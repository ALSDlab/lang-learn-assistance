                    ...
                    child: InkWell(
                      ...
                      child: Ink(
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20),
                            color: (viewModel.selectedOptions[index] == null)
                                ...
                                : (viewModel.checkTapped[index] != null)
                                    ...
                                    : (buttonListIndex !=
                                            viewModel.selectedOptions[index])
                                        ? const Color(0xFFEBF4F6)
                                        : (viewModel.selectedOptions[index] ==
                                                0)
                                            ? const Color(0xFF37B7C3)
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    ...
                    borderRadius: BorderRadius.circular(20),
                    onTap: () {
                      if (viewModel.checkTapped.where((e) => e==null).isNotEmpty){animatedTo();}
                      else {
                    ...
                    child: Ink(
                      ...
                      child: Container(
                        alignment: Alignment.center,
                        child: Text((viewModel.checkTapped.where((e) => e==null).isNotEmpty) ?
                          'NEXT' : 'RESULT',
                          style: TextStyle(
                              fontSize: 15,
                              color: (state.checkTapped)
